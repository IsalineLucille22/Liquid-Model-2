...
z(z<=0) = 0;
k_1 = 3.567477e+01; k_2 = 3.567477e+01; 
T_1 = 0*1/(1 + (threshold(1)/z(6))^k_1);%(z(6) - threshold(1) > 0); %Threshold function use of W_2 by S_1
T_2 = 0*1/(1 + (threshold(2)/z(5))^k_2);%(z(5) - threshold(2) > 0); %Threshold function use of W_1 by S_2
...
df =  T_1*kappa(1,4)*z(1)*z(6) + T_2*kappa(2,4)*z(2)*z(5);
