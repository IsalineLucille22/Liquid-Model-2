...
dx_1 = (2*kappa(1,2) + kappa(1,3))*z(3) - kappa(1,1)*z(1)*z(7) - T_W_2*kappa(1,4)*z(1)*z(6) + alpha(1)*z(1); 
dx_2 = (2*kappa(2,2) + kappa(2,3))*z(4) - kappa(2,1)*z(2)*z(7) - T_W_1*kappa(2,4)*z(2)*z(5) + alpha(2)*z(1);
